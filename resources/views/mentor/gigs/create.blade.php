...
<section class="dashboard">
    <div class="dashboard__inner">
        ...
        <div class="profile__card" style="max-width: 700px;">
            <form method="POST" action="{{ route('mentor.gigs.store') }}" class="form" enctype="multipart/form-data">
                @csrf
                ...
                {{-- ── Cover Image Upload ── --}}
                <div class="form__group">
                    <label class="form__label">Cover Image <span style="font-weight:400;color:var(--color-text-muted)">(optional — auto-assigned if left blank)</span></label>
                    <div class="gig-img-upload" id="gigImgUpload" onclick="document.getElementById('cover_image').click()">
                        <img id="gigImgPreview" src="" alt="" style="display:none;width:100%;height:100%;object-fit:cover;border-radius:10px">
                        <div id="gigImgPlaceholder" style="display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;gap:.5rem;color:var(--color-text-muted)">
                            <span style="font-size:2.5rem">🖼️</span>
                            <span style="font-weight:600;font-size:.9rem">Click to upload a cover image</span>
                            <span style="font-size:.75rem">JPEG, PNG or WebP · max 2 MB</span>
                            <span style="font-size:.72rem;color:var(--color-primary);margin-top:.25rem">If skipped, a category image will be auto-selected 🎨</span>
                        </div>
                    </div>
