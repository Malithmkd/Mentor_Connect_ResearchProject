...
<div class="adm-page-header">
    <div>
        <h1 class="adm-page-title">Add New Skill</h1>
        <p class="adm-page-subtitle">Add a new skill to the master list.</p>
    </div>
    ...
    <div style="padding:1.5rem">
        <form method="POST" action="{{ route('admin.skills.store') }}">
            ...
            <div style="display:flex;gap:.75rem">
                <button type="submit" class="adm-btn adm-btn--primary">Create Skill</button>
